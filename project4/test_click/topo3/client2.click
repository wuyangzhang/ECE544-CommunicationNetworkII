...
rp1::RouterPort(DEV $dev18, IN_MAC $addrDev18, OUT_MAC $addrDev17)

//client1::ClientModule(MY_ADDRESS 102, K 1, OTHER_ADDR1 101, OTHER_ADDR2 100, OTHER_ADDR3 103, DELAY 20, PERIOD 5, TIME_OUT 2)
//client1::ClientModule(MY_ADDRESS 102, K 2, OTHER_ADDR1 101, OTHER_ADDR2 100, OTHER_ADDR3 103, DELAY 20, PERIOD 5, TIME_OUT 2)
client1::ClientModule(MY_ADDRESS 102, K 3, OTHER_ADDR1 101, OTHER_ADDR2 100, OTHER_ADDR3 103, DELAY 20, PERIOD 5, TIME_OUT 2)
