...
rp0::RouterPort(DEV $dev11, IN_MAC $addrDev11, OUT_MAC $addrDev12)
rp1::RouterPort(DEV $dev10, IN_MAC $addrDev10, OUT_MAC $addrDev9)
rp2::RouterPort(DEV $dev13, IN_MAC $addrDev13, OUT_MAC $addrDev14)
