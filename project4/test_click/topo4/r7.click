...
//									  \				          						  |
//                                     \										   [veth24]
//										------[veth8]Router4[veth13]-------[veth14]Router7[veth19]---[veth20]Client3
//
// ************************* define router output link ! **********************************************************************
rp0::RouterPort(DEV $dev14, IN_MAC $addrDev14, OUT_MAC $addrDev13)
rp1::RouterPort(DEV $dev24, IN_MAC $addrDev24, OUT_MAC $addrDev23)
...
// ************************* @initiate address ! **********************************************************************
rt::RoutingTable(MY_ADDRESS 7)
hello::HelloModule(MY_ADDRESS 7, DELAY 1, PERIOD 5, TIME_OUT 2, ACK_TABLE ack, ROUTING_TABLE rt)
update::UpdateModule(MY_ADDRESS 7,DELAY 5, PERIOD 5, TIME_OUT 2,  ACK_TABLE ack, ROUTING_TABLE rt)
