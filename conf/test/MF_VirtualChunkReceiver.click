...
//vtableQ::ThreadSafeQueue(100); //Queue infront of Virtual table lookup element
...
//mf_cla[2] -> [0]dup_lsa; //Not using any more 
//dup_lsa[0] -> [0]lsa_hndlr;
//dup_lsa[1] -> [1]vlsa_hndlr;
...
//lsa_hndlr[1] -> [1]vlsa_hndlr; //outgoing lsa
...
hdlr_cla[2] -> vchnk_snk::MF_VirtualChunkSink(CHUNK_MANAGER chk_mngr);
