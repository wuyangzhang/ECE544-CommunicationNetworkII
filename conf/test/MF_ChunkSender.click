...
//L3 chunk sources
//chunk generator 
chk_src::MF_ChunkSource(SRC_GUID $src_GUID, DST_GUID $dst_GUID, SIZE $chk_size, LIMIT $chk_lmt, ROUTER_STATS routerstats, CHUNK_MANAGER chk_mngr, SERVICE_ID $service_id, PKT_SIZE $pkt_size, INTERVAL $chk_intval, DST_NA $dst_NAs, DELAY $delay); 
...
StaticThreadSched(fd_core 0, chk_src 0, inUnq 1, nbUnq 1, segUnq 1, swUnq 1, td_core 2, seg 2, lp_hndlr 3, lsa_hndlr 3, rtg_tbl 3, g1Unq 3, g2Unq 3, gnrs_svc_sndr 3, gnrs_svc_lstnr 3);
