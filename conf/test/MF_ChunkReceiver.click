...
//L2 packet sources
//core port
fd_core::FromDevice($core_dev, PROMISC false, SNIFFER true, BURST 8);
...
agg[0] 
	-> inCntr_chunk 
	-> chnk_snk::MF_ChunkSink(CHUNK_MANAGER chk_mngr);
...
StaticThreadSched(fd_core 0, inUnq 1, td_core 2, lp_hndlr 3, lsa_hndlr 3, rtg_tbl 3);
