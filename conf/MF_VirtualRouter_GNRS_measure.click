...
vtopo_mngr::MF_VirtualTopologyManager(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, MY_VIRTUAL_NETWORK_GUID $my_virtual_network_GUID, VIRTUAL_TOPO_FILE $virtual_topo_file, VIRTUAL_CONFIG_FILE $virtual_config_file);

//Virtual Elements
vguid_map::MF_VirtualGUIDmap(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, VIRTUAL_CONFIG_FILE $virtual_config_file);
vnbr_tbl::MF_VirtualNeighborTable(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, VIRTUAL_GUID_MAP vguid_map, VIRTUAL_TOPO_FILE $virtual_topo_file, VIRTUAL_CONFIG_FILE $virtual_config_file, ROUTING_TABLE rtg_tbl, NEIGHBOR_TABLE nbr_tbl, CHUNK_MANAGER chk_mngr);
vrtg_tbl::MF_VirtualRoutingTable(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, VIRTUAL_GUID_MAP vguid_map, VIRTUAL_SERVICE_FILE $virtual_service_file, VIRTUAL_NEIGHBOR_TABLE vnbr_tbl, ROUTING_TABLE rtg_tbl, NEIGHBOR_TABLE nbr_tbl, CHUNK_MANAGER chk_mngr);
vlsa_hndlr::MF_VirtualLSAHandler(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, MY_VIRTUAL_NETWORK_GUID $my_virtual_network_GUID, VIRTUAL_NEIGHBOR_TABLE vnbr_tbl, VIRTUAL_ROUTING_TABLE vrtg_tbl, CHUNK_MANAGER chk_mngr);
vdata_forwarding::MF_VirtualDataForwarding(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, MY_VIRTUAL_NETWORK_GUID $my_virtual_network_GUID, VIRTUAL_GUID_MAP vguid_map, VIRTUAL_ROUTING_TABLE vrtg_tbl, CHUNK_MANAGER chk_mngr);
voverhead_measurement::MF_VirtualOverheadMeasure(MY_GUID $my_GUID, MY_VIRTUAL_GUID $my_virtual_GUID, MY_VIRTUAL_NETWORK_GUID $my_virtual_network_GUID, OVERHEAD_MEASURE_FILE $overhead_measure_file, CHUNK_MANAGER chk_mngr);
...
//hdlr_cla[1] -> [0]vlsa_hndlr;
hdlr_cla[2] -> [0]vdata_forwarding;
//hdlr_cla[3] -> [0]vlsa_hndlr;
hdlr_cla[4] -> Print(WARN_UNHANDLED_HANDLER_TYPE) -> chnk_snk;

hdlr_cla[1] -> [0]dup_vlsa;
dup_vlsa[0] -> [0]vlsa_hndlr;
dup_vlsa[1] -> [0]voverhead_measurement;

hdlr_cla[3] -> [0]dup_vlsa;
dup_vlsa[0] -> [0]vlsa_hndlr;
dup_vlsa[1] -> [0]voverhead_measurement;

vlsa_hndlr[0] -> net_binderQ;

vdata_forwarding[0] -> net_binderQ;
